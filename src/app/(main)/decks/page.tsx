...
export default function DecksPage() {
  ...
  useEffect(() => {
    fetch('/api/decks?visibility=Public')
      .then(res => res.json())
      .then(data => {
        if (data.data) {
          setDecks(data.data);
  ...
  return (
    <div className="flex-1 flex flex-col p-8 sm:p-12 max-w-6xl mx-auto w-full">
      <div className="mb-6 flex justify-between items-end">
        <div>
          <h1 className="text-4xl font-bold mb-2">Decks Library</h1>
          <p className="text-gray-400 text-sm">Explore community decks, find competitive builds, and discover new strategies.</p>
        </div>
